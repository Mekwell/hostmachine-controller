...
export class GamesService {
  private games: GameTemplate[] = [
    { id: 'rust', name: 'Rust', type: 'rust', category: 'game', dockerImage: 'gameservermanagers/gameserver:rust', defaultPort: 28015, defaultEnv: [], icon: '☢️', banner: '/banners/rust.jpg', description: 'Hardcore survival.', variables: [], requiredOs: 'linux' },
    { id: 'cs2', name: 'Counter-Strike 2', type: 'cs2', category: 'game', dockerImage: 'gameservermanagers/gameserver:cs2', defaultPort: 27015, defaultEnv: [], icon: '🔫', banner: '/banners/cs2.jpg', description: 'Tactical shooter.', variables: [], requiredOs: 'linux' },
    { id: 'gmod', name: 'Garrys Mod', type: 'gmod', category: 'game', dockerImage: 'gameservermanagers/gameserver:gmod', defaultPort: 27015, defaultEnv: [], icon: '🔧', banner: '/banners/gmod.jpg', description: 'Physics sandbox.', variables: [], requiredOs: 'linux' },
    ...
    { id: 'sf', name: 'Satisfactory', type: 'sf', category: 'game', dockerImage: 'gameservermanagers/gameserver:sf', defaultPort: 7777, defaultEnv: [], icon: '🏭', banner: '/banners/sf.jpg', description: 'Factory sim.', variables: [], requiredOs: 'linux' },
    ...
    { id: 'asa-win', name: 'ARK: Ascended (Windows Native)', type: 'asa', category: 'game', dockerImage: 'hostmachine/game-ark-ascended-win:latest', defaultPort: 7777, defaultEnv: ["SERVER_NAME=ARK-ASA-WIN", "MAX_PLAYERS=70"], icon: '🪟', banner: '/banners/ark.jpg', description: 'Headless Windows Server Core build.', variables: [
        { name: 'Session Name', description: 'Public name', envVar: 'SERVER_NAME', defaultValue: 'ARK-ASA-WIN', type: 'string' },
        { name: 'Server Password', description: 'Optional join pass', envVar: 'PASSWORD', defaultValue: '', type: 'string' },
        { name: 'Admin Password', description: 'Cheat console pass', envVar: 'ADMIN_PASSWORD', defaultValue: '', type: 'string' },
        { name: 'Max Players', description: 'Max 70 recommended', envVar: 'MAX_PLAYERS', defaultValue: '70', type: 'number' }
    ], requiredOs: 'windows' },
    { id: 'pw', name: 'Palworld', type: 'pw', category: 'game', dockerImage: 'gameservermanagers/gameserver:pw', defaultPort: 8211, defaultEnv: [], icon: '🐾', banner: '/banners/pw.jpg', description: 'Monster survival.', variables: [], requiredOs: 'linux' },
    ...
    { id: 'arma3', name: 'ARMA 3', type: 'arma3', category: 'game', dockerImage: 'gameservermanagers/gameserver:arma3', defaultPort: 2302, defaultEnv: [], icon: '🎖️', banner: '/banners/arma3.jpg', description: 'Military sim.', variables: [], requiredOs: 'linux' },
    { id: 'dayz', name: 'DayZ', type: 'dayz', category: 'game', dockerImage: 'gameservermanagers/gameserver:dayz', defaultPort: 2302, defaultEnv: [], icon: '🧟', banner: '/banners/dayz.jpg', description: 'Hardcore survival.', variables: [], requiredOs: 'linux' },

    { id: 'ts3', name: 'Teamspeak 3', type: 'voip', category: 'voip', dockerImage: 'teamspeak:latest', defaultPort: 9987, defaultEnv: ["TS3SERVER_LICENSE=accept"], icon: '🎙️', banner: '/banners/ts3.jpg', description: 'Pro voice chat.', variables: [], requiredOs: 'linux' },
    { id: 'mumble', name: 'Mumble (Murmur)', type: 'voip', category: 'voip', dockerImage: 'mumblevoip/mumble-server:latest', defaultPort: 64738, defaultEnv: [], icon: '📻', banner: '/banners/mumble.jpg', description: 'Low-latency VOIP.', variables: [], requiredOs: 'linux' },

    { id: 'nginx', name: 'Nginx Web Server', type: 'web', category: 'web', dockerImage: 'nginx:latest', defaultPort: 80, defaultEnv: [], icon: '🌐', banner: '/banners/nginx.jpg', description: 'High-perf web server.', variables: [], requiredOs: 'linux' },
    { id: 'nodejs', name: 'Node.js Runtime', type: 'web', category: 'web', dockerImage: 'node:latest', defaultPort: 3000, defaultEnv: [], icon: '🟢', banner: '/banners/nodejs.jpg', description: 'JS app hosting.', variables: [], requiredOs: 'linux' },
    { id: 'ghost', name: 'Ghost Blog', type: 'web', category: 'web', dockerImage: 'ghost:latest', defaultPort: 2368, defaultEnv: [], icon: '👻', banner: '/banners/ghost.jpg', description: 'Modern publishing.', variables: [], requiredOs: 'linux' },
    { id: 'wordpress', name: 'WordPress Site', type: 'web', category: 'web', dockerImage: 'wordpress:latest', defaultPort: 80, defaultEnv: [], icon: '📝', banner: '/banners/wordpress.jpg', description: 'Classic CMS.', variables: [], requiredOs: 'linux' }
  ];
